...
last_updated: "2026-08-04T07:32:19.351Z"
last_activity: 2026-08-04
last_activity_desc: "04-05 executed: native/register is FINISHED and it is the first plan in this phase that needed NO human retirement decision — zero ids retired, zero re-pointed, zero changed hashes across both commits, because the plan's own reading was right that the six Phase 3 entries are correct and their pairing already works. The warm-up went from three contrasting pairs to NINE (6 phrases to 18): a request, an apology and a refusal were already here; bad news, a chase-up, a disagreement, an ask for more time, praise and a correction are new, each said once casually and once formally WITH THE SAME FACTS IN BOTH HALVES, because softening the content out of the polite version is the failure this scenario exists to prevent. Every one of the twelve carries a use-and-audience tip and none translates its line. The deck went 8 to 24 and is deliberately MORE GRAMMAR THAN VOCABULARY — a full form, the agentless passive, the distancing past, nominalisation, a bare imperative — because RESEARCH section 5 says register in English is carried by grammar more than by word choice, and ScenarioVocabCard holds a marker perfectly well without becoming a new item type (D-01). Four strands: the grammar of the dial (5), the moves around bad news (4), what it looks like on the page (3), who is in the room (4, the Spanish-speaker collisions). NEW HARNESS GATE, and it is the project's FIRST assertion on ARRAY ORDER AS A TEACHING PROPERTY: native/register's pairing is carried by adjacency and by NOTHING ELSE — no field records which entry pairs with which, and both renderers walk the array from index 0, so a casual half separated from its formal half still type-checks, still passes every other assertion in the file, still renders eighteen perfectly good phrases, and quietly stops teaching the one thing the scenario is for. Three SEPARABLE checks plus a vacuity guard: the set resolves and is non-empty; even length; alternation by the casual-/formal- slug prefix against the index; and adjacency stated separately because it is the property the RENDERERS depend on. A negative mutation (alternation neutered, a reversed pair appended) proved adjacency still fires, so check 3 is NOT redundant with check 2. The slugs deliberately do not share a stem (casual-my-bad pairs with formal-apologise-oversight), so suffix matching is not and must not become the mechanism. Measured clean before asserting: 18 entries, 0 alternation violations, 0 untipped, 9 well-formed pairs. THE PRE-AUTHORING CORPUS SCAN KILLED FOUR CARDS AND THREE OF THEM THE PLAN HAD NAMED BY NAME: understatement (social/humor teaches it), sign-off (work/emails, same id and same term), filler (work/presentations, as 'a filler word') and tag-question (social/small-talk's grammar bank drills the unit). Naming a marker in a plan does not make it free. Replaced by downplay something, a salutation, textspeak and deferential. Two more fields were rewritten after drafting (salutation.es at J=0.500 against tech-support's 'un mensaje de error', rewritten for CLARITY in a way that also drops it to 0.182; textspeak.example sharing a six-word frame with the LIVE stilted card inside the same deck). THEN THE TWENTY-FOUR WERE READ CONSECUTIVELY, which the scan cannot substitute for, and four SHARED SYNTACTIC FRAMES turned up that no Jaccard threshold flagged — over-hedge and downplay scored 0.15 on their examples while sharing an identical skeleton, adjacent on the page. All four rewritten. Zero exact duplicates; deck highest 0.500 (a 3-word denominator, 'X something' being this repo's own verb-card shape), phrases highest 0.375; the >=6-word view tops out at 0.333, and NOTHING reached 0.60, so this plan files no WINDOWS judgement of 04-04's kind. minutes 9 to 13 at Task 1 and 13 to 17 at Task 2, each in the same commit as the growth (18x20 + 42-card deck x15 = 990 s, 30 s slack). verify-scenario-content 13477 to 13832; verify-id-stability 1791 to 1875, 604 ids and 15 retired (UNCHANGED); payload 191,945 B / 18.3 percent over 705 ids; merge 25647, schema 309, queue 173, headers 24, celpip 43/648/50 all held; tsc, lint and build exit 0 from the committed tree after a .next wipe, with the bundle grepped for the new slugs and minutes:17; dependencies 11 + 11; port 3000 free. Mutation sweep 7 declared / 7 executed / 5 of 5 CAUGHT / negative confirmed / 2 controls green / byte-identity IDENTICAL, smoke-tested in both directions first. M3 REPORTED THE WRONG LABEL ON RUN 1 AND THE MUTATION WAS THE DEFECT, not the gate: the reversed pair was inserted BEFORE the last entry, landing at indices 17/18 where a formal-then-casual pair alternates CORRECTLY, so the only assertion that fired was the session-length one. Fixed to append after the last entry. 04-04's rule applied rather than restated. ONE COMMENT-ONLY DEVIATION: curriculum.ts's native/idioms sitting comment still described 04-03's 26-card deck and 13 minutes beside an entry reading minutes:17 — corrected. NOT FIXED and logged to deferred-items.md and WINDOWS: native/register's BRIEFING quotes the opening shapes of its own pair 1 ('Can you...?' becomes 'Would you be able to...?'). 04-04's briefing/bank separation gate is scoped to native/idioms and does not fire; widening it to all 35 briefings is a decision about the gate, and this plan does not own scenario-lessons.ts. Also recorded as a judgement: the chase-up pair overlaps in SITUATION with the scenario's own rehearsal, kept with different material because the rehearsal supplies no lines. WINDOWS 45 RECURRED FOR A THIRTEENTH CONSECUTIVE PLAN: state.advance-plan/update-progress again rewrote total_phases 6 to 5 and update-progress again DELETED the informative Progress parenthetical, replacing it with a bare '91%'. Both hand-corrected, touching only my own rows, with the 109 historical [Phase ?] lines counted before and after to prove they were untouched. record-metric DID write its row this time, unlike at 04-04. CONT-04 NOT ticked — this is plan five of nine and native/pronunciation and native/culture still sit at Phase 3 floors. 4 of 9 plans remain in Phase 4."
progress:
  total_phases: 5
  completed_phases: 4
  total_plans: 45
...
**Current focus:** Phase 04 — native-level-depth (IN PROGRESS, 5 of 9 plans; CONT-04)
...
Last activity: 2026-08-04 — 04-05 executed: native/register is FINISHED and it is the first plan in this phase that needed NO human retirement decision — zero ids retired, zero re-pointed, zero changed hashes across both commits, because the plan's own reading was right that the six Phase 3 entries are correct and their pairing already works. The warm-up went from three contrasting pairs to NINE (6 phrases to 18): a request, an apology and a refusal were already here; bad news, a chase-up, a disagreement, an ask for more time, praise and a correction are new, each said once casually and once formally WITH THE SAME FACTS IN BOTH HALVES, because softening the content out of the polite version is the failure this scenario exists to prevent. Every one of the twelve carries a use-and-audience tip and none translates its line. The deck went 8 to 24 and is deliberately MORE GRAMMAR THAN VOCABULARY — a full form, the agentless passive, the distancing past, nominalisation, a bare imperative — because RESEARCH section 5 says register in English is carried by grammar more than by word choice, and ScenarioVocabCard holds a marker perfectly well without becoming a new item type (D-01). Four strands: the grammar of the dial (5), the moves around bad news (4), what it looks like on the page (3), who is in the room (4, the Spanish-speaker collisions). NEW HARNESS GATE, and it is the project's FIRST assertion on ARRAY ORDER AS A TEACHING PROPERTY: native/register's pairing is carried by adjacency and by NOTHING ELSE — no field records which entry pairs with which, and both renderers walk the array from index 0, so a casual half separated from its formal half still type-checks, still passes every other assertion in the file, still renders eighteen perfectly good phrases, and quietly stops teaching the one thing the scenario is for. Three SEPARABLE checks plus a vacuity guard: the set resolves and is non-empty; even length; alternation by the casual-/formal- slug prefix against the index; and adjacency stated separately because it is the property the RENDERERS depend on. A negative mutation (alternation neutered, a reversed pair appended) proved adjacency still fires, so check 3 is NOT redundant with check 2. The slugs deliberately do not share a stem (casual-my-bad pairs with formal-apologise-oversight), so suffix matching is not and must not become the mechanism. Measured clean before asserting: 18 entries, 0 alternation violations, 0 untipped, 9 well-formed pairs. THE PRE-AUTHORING CORPUS SCAN KILLED FOUR CARDS AND THREE OF THEM THE PLAN HAD NAMED BY NAME: understatement (social/humor teaches it), sign-off (work/emails, same id and same term), filler (work/presentations, as 'a filler word') and tag-question (social/small-talk's grammar bank drills the unit). Naming a marker in a plan does not make it free. Replaced by downplay something, a salutation, textspeak and deferential. Two more fields were rewritten after drafting (salutation.es at J=0.500 against tech-support's 'un mensaje de error', rewritten for CLARITY in a way that also drops it to 0.182; textspeak.example sharing a six-word frame with the LIVE stilted card inside the same deck). THEN THE TWENTY-FOUR WERE READ CONSECUTIVELY, which the scan cannot substitute for, and four SHARED SYNTACTIC FRAMES turned up that no Jaccard threshold flagged — over-hedge and downplay scored 0.15 on their examples while sharing an identical skeleton, adjacent on the page. All four rewritten. Zero exact duplicates; deck highest 0.500 (a 3-word denominator, 'X something' being this repo's own verb-card shape), phrases highest 0.375; the >=6-word view tops out at 0.333, and NOTHING reached 0.60, so this plan files no WINDOWS judgement of 04-04's kind. minutes 9 to 13 at Task 1 and 13 to 17 at Task 2, each in the same commit as the growth (18x20 + 42-card deck x15 = 990 s, 30 s slack). verify-scenario-content 13477 to 13832; verify-id-stability 1791 to 1875, 604 ids and 15 retired (UNCHANGED); payload 191,945 B / 18.3 percent over 705 ids; merge 25647, schema 309, queue 173, headers 24, celpip 43/648/50 all held; tsc, lint and build exit 0 from the committed tree after a .next wipe, with the bundle grepped for the new slugs and minutes:17; dependencies 11 + 11; port 3000 free. Mutation sweep 7 declared / 7 executed / 5 of 5 CAUGHT / negative confirmed / 2 controls green / byte-identity IDENTICAL, smoke-tested in both directions first. M3 REPORTED THE WRONG LABEL ON RUN 1 AND THE MUTATION WAS THE DEFECT, not the gate: the reversed pair was inserted BEFORE the last entry, landing at indices 17/18 where a formal-then-casual pair alternates CORRECTLY, so the only assertion that fired was the session-length one. Fixed to append after the last entry. 04-04's rule applied rather than restated. ONE COMMENT-ONLY DEVIATION: curriculum.ts's native/idioms sitting comment still described 04-03's 26-card deck and 13 minutes beside an entry reading minutes:17 — corrected. NOT FIXED and logged to deferred-items.md and WINDOWS: native/register's BRIEFING quotes the opening shapes of its own pair 1 ('Can you...?' becomes 'Would you be able to...?'). 04-04's briefing/bank separation gate is scoped to native/idioms and does not fire; widening it to all 35 briefings is a decision about the gate, and this plan does not own scenario-lessons.ts. Also recorded as a judgement: the chase-up pair overlaps in SITUATION with the scenario's own rehearsal, kept with different material because the rehearsal supplies no lines. WINDOWS 45 RECURRED FOR A THIRTEENTH CONSECUTIVE PLAN: state.advance-plan/update-progress again rewrote total_phases 6 to 5 and update-progress again DELETED the informative Progress parenthetical, replacing it with a bare '91%'. Both hand-corrected, touching only my own rows, with the 109 historical [Phase ?] lines counted before and after to prove they were untouched. record-metric DID write its row this time, unlike at 04-04. CONT-04 NOT ticked — this is plan five of nine and native/pronunciation and native/culture still sit at Phase 3 floors. 4 of 9 plans remain in Phase 4.

Progress: [█████████░] 41 of 45 plans (4 of 6 phases complete; Phase 4 has 9 plans written and 5 executed)
...
Last session: 2026-08-04T07:29:10.569Z
