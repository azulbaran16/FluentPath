...
last_updated: "2026-08-04T09:22:50.227Z"
last_activity: 2026-08-04
last_activity_desc: "04-07 executed: ALL FIVE native scenarios now carry depth, and native/pronunciation is DELIBERATELY the smallest of them - 12 phrases and 16 cards against its four neighbours' 18 and 24 - with the reason written into BOTH bank headers rather than left as an unexplained gap. Under D-01 the drills this skill actually needs (minimal pairs, word stress, intonation AS EXERCISES) are precisely the new components that were ruled out, so volume buys less here than anywhere else and padding it to a uniform floor would have implied the five were deepened equally when they were not. NOT ONE ADDED LINE IS A TONGUE-TWISTER: all six follow ship-sheep, the one item in the set that already worked, putting the contrast inside a sentence a person would really say so the recogniser has a real WORD to get right or wrong. The contrasts are /v/ vs /b/ (taking the dog to the vet, and Spanish has no /v/ at all), /th/ vs /t/ (Thursday not Tuesday, the confusion that makes you arrive two days early), /dh/ vs /d/ (hang those clothes up, three /dh/ in one natural sentence), the initial st- cluster (a state school, where the vowel that creeps in front makes estate), final /d/ voicing carrying a TENSE (I send an update, which devoiced becomes sent), and the noun/verb stress shift (re-CORD against RE-cord). THE PLAN NAMED SIX CONTRASTS AND ONE WAS ALREADY TAKEN: the short/long vowel pair's draft gloss came back at J=1.000 against the LIVE ship-sheep.es - the same words in a different order, same contrast, same set - so it was killed before it was written and /v/-/b/ took the slot because nothing in the bank covered it. Sixth consecutive plan where an item the plan itself named turned out to be the duplicate. Two more collisions cleared pre-authoring on the send-an-update line (a whole shared clause with practical/banking's direct-debit example, then the send-them-a frame of the LIVE work/emails gentle-nudge). THE DECK went 8 to 16 in four strands - what unstressed syllables do (the schwa, a weak form), what happens between words (linking and elision), what the consonant itself is doing (aspiration, voiced and voiceless), what the whole sentence is doing (sentence stress explicitly AGAINST the live word-stress card, a rising tone) - plus the one that tells her where NOT to spend the effort: an accent, not a mistake. EVERY example is a correction being GIVEN rather than a definition restated, because recognising the correction when it arrives is this deck's whole value. THE VOICE-01 CASE IS NOW EVIDENCE-BACKED RATHER THAN ASSERTED, and it is an explicit input to the phase gate's annotation of CONT-04: PronunciationLab scores WORD BY WORD against the browser recogniser and cannot see vowel length, aspiration or stress at all. record-it-and-a-record drills exactly what the scorer is blind to, and THE ITEM SAYS SO IN ITS OWN TIP rather than shipping the limitation silently - T-04-15 reported partially unmet, 5 of 6, by the nature of stress. The other five only work because their errors happen to produce different WORDS, which is a lucky property of segmental minimal pairs and not a property of the scorer; the 16-card deck exists at all because the feedback loop is somebody else telling her. MEASURED AND KEPT WITH THE NUMBER: sentence stress scores J=0.667 against the GLOBAL speaking-tip panel titled Word and sentence stress, whose points also brush weak forms, linking and the contour. Kept, with the measurement written into the deck header, because that panel is prose on the Speaking skill page - no term, no Spanish, nothing scheduled - and this deck has coexisted with it since Phase 3 on word stress and intonation already. a rising tone was deliberately given a THIRD signal (an open list) so it repeats neither that panel nor the live intonation card. Corpus scan run on 04-06's REBUILT harvester at 4,523 fields rising to 4,565: 189,966 comparisons for the phrases and 108,984 for the deck, ZERO exact duplicates. Then both banks READ CONSECUTIVELY and five more frames rewritten that no threshold flagged - three tips sharing the same Spanish sale construction, schwa opening on the second syllable exactly as the live word-stress card does, aspiration as the third card to open on Your, and accent echoing the live mumble card's nobody. All five caught while uncommitted, so all five were free. MINUTES NOT LOWERED AT TASK 1 and that is a deviation from the plan's wording: at 12 phrases and a 20-card deck the smallest whole minute the invariant allows is 9, BELOW the standing 10, and shrinking an advertised sitting inside the commit that grows the bank behind it points the wrong way - 04-01's rule is that this budget is always fixed by raising. Held at 10, then raised to 11 at Task 2 exactly as planned (12x20 + 28x15 = 660 s, zero slack under >=). THE ID GATE FIRED ON ME AND IT WAS RIGHT: I regenerated the fixture BEFORE finishing the reader pass, then rewrote two tips, and the second --update REFUSED both ids as re-points. Hazard 5 says regenerate ONCE after content is final and I had not; recovered by restoring the fixture to its committed baseline with git show HEAD (chosen over git checkout -- because the source files beside it held uncommitted work), verifying phrases.ts and curriculum.ts were untouched by the restore, then regenerating once. verify-scenario-content 14325 to 14479; verify-id-stability 1959 to 2001, 646 ids and 15 retired (UNCHANGED); ZERO ids retired, ZERO re-pointed, ZERO changed hashes, so NO one-way-door decision was put to the user for the THIRD consecutive plan. Payload 203,699 B / 19.4 percent over 747 ids; merge 25647, schema 309, queue 173, headers 24, celpip 43/648/50 all held; tsc, lint and build exit 0 from the COMMITTED tree after a .next wipe, with the bundle grepped for the new slugs and minutes:11; dependencies 11 + 11; port 3000 free before and after. DERIVED HERE SO 04-08 NEED NOT RE-DERIVE IT: there is no honest new skill declaration for this scenario - reading and writing do not train pronunciation, and a GrammarQuestion about stress placement would be a drill component in a quiz's clothing, the line D-01 draws. WINDOWS 45 RECURRED FOR A FIFTEENTH CONSECUTIVE PLAN, with one improvement: record-metric DID write its row correctly this time (the Performance Metrics table is real and populated, contrary to 04-06's reading), but update-progress again deleted the informative Progress parenthetical for a bare 96 percent and again reset total_phases from 6 to 5 against a ROADMAP holding 6, AND record-session reset total_phases a SECOND time after I had hand-corrected it - so the correction must come after every verb, not after the first. All hand-corrected, touching only my own rows; the 152 pre-existing [Phase ?] decision lines counted before and after and untouched, the 3 new ones being mine. CONT-04 NOT ticked - this is plan seven of nine, with the declarations decision (04-08) and the phase gate (04-09) still outstanding. 2 of 9 plans remain in Phase 4."
progress:
  total_phases: 6
  completed_phases: 4
  total_plans: 45
...
**Current focus:** Phase 04 — native-level-depth (IN PROGRESS, 7 of 9 plans; CONT-04)

## Current Position

Phase: 04 (native-level-depth) — IN PROGRESS
Plan: 7 of 9 complete
Status: 04-07 complete on `main`. **ALL FIVE native scenarios now carry depth — four of them
...
Last activity: 2026-08-04 — 04-07 executed: ALL FIVE native scenarios now carry depth, and native/pronunciation is DELIBERATELY the smallest of them - 12 phrases and 16 cards against its four neighbours' 18 and 24 - with the reason written into BOTH bank headers rather than left as an unexplained gap. Under D-01 the drills this skill actually needs (minimal pairs, word stress, intonation AS EXERCISES) are precisely the new components that were ruled out, so volume buys less here than anywhere else and padding it to a uniform floor would have implied the five were deepened equally when they were not. NOT ONE ADDED LINE IS A TONGUE-TWISTER: all six follow ship-sheep, the one item in the set that already worked, putting the contrast inside a sentence a person would really say so the recogniser has a real WORD to get right or wrong. The contrasts are /v/ vs /b/ (taking the dog to the vet, and Spanish has no /v/ at all), /th/ vs /t/ (Thursday not Tuesday, the confusion that makes you arrive two days early), /dh/ vs /d/ (hang those clothes up, three /dh/ in one natural sentence), the initial st- cluster (a state school, where the vowel that creeps in front makes estate), final /d/ voicing carrying a TENSE (I send an update, which devoiced becomes sent), and the noun/verb stress shift (re-CORD against RE-cord). THE PLAN NAMED SIX CONTRASTS AND ONE WAS ALREADY TAKEN: the short/long vowel pair's draft gloss came back at J=1.000 against the LIVE ship-sheep.es - the same words in a different order, same contrast, same set - so it was killed before it was written and /v/-/b/ took the slot because nothing in the bank covered it. Sixth consecutive plan where an item the plan itself named turned out to be the duplicate. Two more collisions cleared pre-authoring on the send-an-update line (a whole shared clause with practical/banking's direct-debit example, then the send-them-a frame of the LIVE work/emails gentle-nudge). THE DECK went 8 to 16 in four strands - what unstressed syllables do (the schwa, a weak form), what happens between words (linking and elision), what the consonant itself is doing (aspiration, voiced and voiceless), what the whole sentence is doing (sentence stress explicitly AGAINST the live word-stress card, a rising tone) - plus the one that tells her where NOT to spend the effort: an accent, not a mistake. EVERY example is a correction being GIVEN rather than a definition restated, because recognising the correction when it arrives is this deck's whole value. THE VOICE-01 CASE IS NOW EVIDENCE-BACKED RATHER THAN ASSERTED, and it is an explicit input to the phase gate's annotation of CONT-04: PronunciationLab scores WORD BY WORD against the browser recogniser and cannot see vowel length, aspiration or stress at all. record-it-and-a-record drills exactly what the scorer is blind to, and THE ITEM SAYS SO IN ITS OWN TIP rather than shipping the limitation silently - T-04-15 reported partially unmet, 5 of 6, by the nature of stress. The other five only work because their errors happen to produce different WORDS, which is a lucky property of segmental minimal pairs and not a property of the scorer; the 16-card deck exists at all because the feedback loop is somebody else telling her. MEASURED AND KEPT WITH THE NUMBER: sentence stress scores J=0.667 against the GLOBAL speaking-tip panel titled Word and sentence stress, whose points also brush weak forms, linking and the contour. Kept, with the measurement written into the deck header, because that panel is prose on the Speaking skill page - no term, no Spanish, nothing scheduled - and this deck has coexisted with it since Phase 3 on word stress and intonation already. a rising tone was deliberately given a THIRD signal (an open list) so it repeats neither that panel nor the live intonation card. Corpus scan run on 04-06's REBUILT harvester at 4,523 fields rising to 4,565: 189,966 comparisons for the phrases and 108,984 for the deck, ZERO exact duplicates. Then both banks READ CONSECUTIVELY and five more frames rewritten that no threshold flagged - three tips sharing the same Spanish sale construction, schwa opening on the second syllable exactly as the live word-stress card does, aspiration as the third card to open on Your, and accent echoing the live mumble card's nobody. All five caught while uncommitted, so all five were free. MINUTES NOT LOWERED AT TASK 1 and that is a deviation from the plan's wording: at 12 phrases and a 20-card deck the smallest whole minute the invariant allows is 9, BELOW the standing 10, and shrinking an advertised sitting inside the commit that grows the bank behind it points the wrong way - 04-01's rule is that this budget is always fixed by raising. Held at 10, then raised to 11 at Task 2 exactly as planned (12x20 + 28x15 = 660 s, zero slack under >=). THE ID GATE FIRED ON ME AND IT WAS RIGHT: I regenerated the fixture BEFORE finishing the reader pass, then rewrote two tips, and the second --update REFUSED both ids as re-points. Hazard 5 says regenerate ONCE after content is final and I had not; recovered by restoring the fixture to its committed baseline with git show HEAD (chosen over git checkout -- because the source files beside it held uncommitted work), verifying phrases.ts and curriculum.ts were untouched by the restore, then regenerating once. verify-scenario-content 14325 to 14479; verify-id-stability 1959 to 2001, 646 ids and 15 retired (UNCHANGED); ZERO ids retired, ZERO re-pointed, ZERO changed hashes, so NO one-way-door decision was put to the user for the THIRD consecutive plan. Payload 203,699 B / 19.4 percent over 747 ids; merge 25647, schema 309, queue 173, headers 24, celpip 43/648/50 all held; tsc, lint and build exit 0 from the COMMITTED tree after a .next wipe, with the bundle grepped for the new slugs and minutes:11; dependencies 11 + 11; port 3000 free before and after. DERIVED HERE SO 04-08 NEED NOT RE-DERIVE IT: there is no honest new skill declaration for this scenario - reading and writing do not train pronunciation, and a GrammarQuestion about stress placement would be a drill component in a quiz's clothing, the line D-01 draws. WINDOWS 45 RECURRED FOR A FIFTEENTH CONSECUTIVE PLAN, with one improvement: record-metric DID write its row correctly this time (the Performance Metrics table is real and populated, contrary to 04-06's reading), but update-progress again deleted the informative Progress parenthetical for a bare 96 percent and again reset total_phases from 6 to 5 against a ROADMAP holding 6, AND record-session reset total_phases a SECOND time after I had hand-corrected it - so the correction must come after every verb, not after the first. All hand-corrected, touching only my own rows; the 152 pre-existing [Phase ?] decision lines counted before and after and untouched, the 3 new ones being mine. CONT-04 NOT ticked - this is plan seven of nine, with the declarations decision (04-08) and the phase gate (04-09) still outstanding. 2 of 9 plans remain in Phase 4.

Progress: [█████████░] 43 of 45 plans (4 of 6 phases complete; Phase 4 has 9 plans written and 7 executed)
...
Last session: 2026-08-04T09:22:49.926Z
