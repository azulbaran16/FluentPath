...
last_updated: "2026-08-04T08:29:38.851Z"
last_activity: 2026-08-04
last_activity_desc: "04-06 executed: native/culture is deep and NOTHING IN EITHER BANK HAS A SHELF LIFE - 18 repair phrases and a 24-card deck, not one item's meaning depending on a film, song, programme, advert, person or year. The warm-up went 6 to 18 across three axes the scenario needed and did not have: THE ROOM (a meeting where stopping costs money, a call where nobody can read your face, a group chat where the moment has gone, someone senior who assumed you would get it), THE SPEED (invisible - answer the point and never find out what it was; open; delayed by two turns so nobody re-tells a joke to one person; and the catch that arrives ten seconds late), and THE OTHER DIRECTION (hers lands on nobody, she rescues somebody else's, she offers one back, she gets the room off the subject). Every one of the twelve carries a use note saying who it works with, when it sounds like an excuse and what it costs in the wrong room. The deck went 8 to 24 in four strands - what kind of thing it is, what it does to the room, time, and catching/not catching - and EVERY example insures its own term by context, which is the technique this scenario's own passage uses on the references it drops and the reason its cards run longer than any other deck's. THE PLAN'S SUCCESS CRITERION 3 IS UNMET AND THAT IS THE FINDING: it asks for irony, sarcasm and deadpan 'taught in this world for the first time' on the belief they have no bank today, and they do - social/humor is TITLED 'Humor and sarcasm', holds deadpan, understatement and tongue-in-cheek as cards, drills sarcasm in its briefing intro AND tip[0] AND a live warm-up phrase, and advertises irony in its blurb. Writing them here is the D-01 duplication 04-05 killed understatement for. Not written; reported, with the measurement written into the deck header so the next author inherits it. One card holds that ground legitimately - take something at face value - because it names the CONSEQUENCE of missing a tone rather than the tone. SIX candidates killed by the pre-authoring scan and FOUR of them the plan had named: deadpan, sarcasm, irony, a pointed understatement, plus 'a set-up' (native/phrasal-verbs teaches set up, SAME WORLD) and 'a shared complaint as small talk' (social/humor's reading passage IS the national-grievance essay, glossary and all). Fifth consecutive plan where naming something in a plan did not make it free. NEW HARNESS GATE with ZERO new imports: no four-digit year in either bank, and neither bank names any of the four references the passage's questions ask the reader to recover. Its structural novelty is a DELIBERATE EXCEPTION ASSERTED IN THE POSITIVE - this passage withholds three of its four and GLOSSES the fourth on purpose (the question about 'our white elephant' turns on the possessive, not the phrase), so the record carries a glossed flag, glossary-silence runs on the three, the glossary must REALLY DEFINE the fourth, and the BANK check runs on all four regardless. The flag therefore cannot be flipped onto a second entry to silence an inconvenient check, and a negative mutation proved the exception load-bearing. THE GATE SAYS PLAINLY WHAT IT DOES NOT COVER: a year is the only shelf-life marker a script can see; 'no work, no person, no brand' is the authoring rule and the reader pass, and a gate implying more coverage than it has is worse than none (T-04-13 accepted, in writing). 04-05's CORPUS HARVESTER WAS BROKEN and this plan found it before authoring: its push guard required typeof text === 'string', so every reading passage BODY (a string[]) was silently absent from the corpus, along with every glossary (wrong field names) and every reading question prompt (q.prompt vs q.q). Rebuilt to 4,284 fields against 3,744 - so every scan here covered surfaces no prior plan's scan reached, INCLUDING native/culture's own letter home, which is exactly the text these banks must not collide with. Zero exact duplicates; four fields rewritten after the scan (a Spanish frame shared with social/humor's went-over-my-head, a 'to be honest' tail shared with a LIVE native/register phrase, 'for what it's worth' which native/idioms teaches outright, and 'redundant' which two live cards own in another sense); then both banks READ CONSECUTIVELY and six more rewritten for shared shapes no threshold flagged. Phrases highest J=0.375, deck highest genuine J=0.300, >=6-word view 0.333; one pair at exactly 0.500 (read the room vs work/networking's LIVE work-the-room) was ACTED ON rather than filed, replaced by 'topical'. Five frames found against the EXISTING eight cards were MEASURED at J=0.094-0.129 and KEPT, because clearing them would mean editing a field behind an id committed forty minutes earlier - a changed hash - and a 0.10 overlap does not buy a one-way door. Mutation sweep 10 declared / 8 of 8 CAUGHT / negative confirmed / 2 controls green / byte-identity IDENTICAL. TWO mutations failed on run 1 and BOTH were my mutations' defects, not the gate's: M5 prepended glossed:true to an object that already carried glossed:false - a DUPLICATE KEY, last one wins, semantically inert - and N1 joined its anchor lines with a bare newline against a file that is CRLF on disk, so it matched 0 times and the refusal branch left the file byte-identical. 04-04's rule applied rather than restated. minutes 10 to 13 at Task 1 and 13 to 17 at Task 2, each in the same commit as the growth (18x20 + 42-card deck x15 = 990 s, 30 s slack). verify-scenario-content 13832 to 14325; verify-id-stability 1875 to 1959, 632 ids and 15 retired (UNCHANGED); ZERO ids retired, ZERO re-pointed, ZERO changed hashes, so NO one-way-door decision was put to the user for the second consecutive plan. Payload 199,631 B / 19.0 percent over 733 ids; merge 25647, schema 309, queue 173, headers 24, celpip 43/648/50 all held; tsc, lint and build exit 0 from the COMMITTED tree after a .next wipe, with the bundle grepped for the new slugs and minutes:17; dependencies 11 + 11; port 3000 free before and after. LOGGED TO deferred-items.md AND WINDOWS: native/culture's own BRIEFING says 'That is so 2010' - a literal four-digit year in the one scenario whose banks are now gated against years - but scenario-lessons.ts is outside this plan's files_modified and the tip is arguably demonstrating the phenomenon rather than falling for it. WINDOWS 45 RECURRED FOR A FOURTEENTH CONSECUTIVE PLAN: update-progress again DELETED the informative Progress parenthetical for a bare '93%', total_phases still read 5 against a ROADMAP holding 6 phases, and record-metric AGAIN returned success while writing nothing (the Performance Metrics table has been a placeholder for all 42 plans, so no row was fabricated for this one alone). All hand-corrected, touching only my own rows; the 109 historical [Phase ?] decision lines counted before and after and untouched, the 3 new ones being mine. CONT-04 NOT ticked - this is plan six of nine and native/pronunciation still sits at Phase 3 floors. 3 of 9 plans remain in Phase 4."
progress:
  total_phases: 6
  completed_phases: 4
  total_plans: 45
...
**Current focus:** Phase 04 — native-level-depth (IN PROGRESS, 6 of 9 plans; CONT-04)

## Current Position

Phase: 04 (native-level-depth) — IN PROGRESS
Plan: 6 of 9 complete
Status: 04-05 complete on `main`. **THREE of the five native scenarios are now deep.**
...
pairs (18 phrases) and a 24-card marker deck, 17 minutes**, and it is the first plan in this phase
that opened NO one-way door: zero ids retired, zero re-pointed, zero changed hashes.
`pronunciation` and `culture` still report their Phase 3 floors, truthfully, because coverage is
derived.
...
**Run the corpus scan BEFORE authoring — it has now killed twelve candidates across four plans**,
and at 04-05 three of the four it killed were markers the PLAN ITSELF named. Naming something in a
plan does not make it free. And the scan is not sufficient: reading a finished deck consecutively
found four shared syntactic frames it scored at 0.15.

**Read `04-01-SUMMARY.md` (the contract carrier), then `04-04-SUMMARY.md` and `04-05-SUMMARY.md`,
...
Last activity: 2026-08-04 — 04-06 executed: native/culture is deep and NOTHING IN EITHER BANK HAS A SHELF LIFE - 18 repair phrases and a 24-card deck, not one item's meaning depending on a film, song, programme, advert, person or year. The warm-up went 6 to 18 across three axes the scenario needed and did not have: THE ROOM (a meeting where stopping costs money, a call where nobody can read your face, a group chat where the moment has gone, someone senior who assumed you would get it), THE SPEED (invisible - answer the point and never find out what it was; open; delayed by two turns so nobody re-tells a joke to one person; and the catch that arrives ten seconds late), and THE OTHER DIRECTION (hers lands on nobody, she rescues somebody else's, she offers one back, she gets the room off the subject). Every one of the twelve carries a use note saying who it works with, when it sounds like an excuse and what it costs in the wrong room. The deck went 8 to 24 in four strands - what kind of thing it is, what it does to the room, time, and catching/not catching - and EVERY example insures its own term by context, which is the technique this scenario's own passage uses on the references it drops and the reason its cards run longer than any other deck's. THE PLAN'S SUCCESS CRITERION 3 IS UNMET AND THAT IS THE FINDING: it asks for irony, sarcasm and deadpan 'taught in this world for the first time' on the belief they have no bank today, and they do - social/humor is TITLED 'Humor and sarcasm', holds deadpan, understatement and tongue-in-cheek as cards, drills sarcasm in its briefing intro AND tip[0] AND a live warm-up phrase, and advertises irony in its blurb. Writing them here is the D-01 duplication 04-05 killed understatement for. Not written; reported, with the measurement written into the deck header so the next author inherits it. One card holds that ground legitimately - take something at face value - because it names the CONSEQUENCE of missing a tone rather than the tone. SIX candidates killed by the pre-authoring scan and FOUR of them the plan had named: deadpan, sarcasm, irony, a pointed understatement, plus 'a set-up' (native/phrasal-verbs teaches set up, SAME WORLD) and 'a shared complaint as small talk' (social/humor's reading passage IS the national-grievance essay, glossary and all). Fifth consecutive plan where naming something in a plan did not make it free. NEW HARNESS GATE with ZERO new imports: no four-digit year in either bank, and neither bank names any of the four references the passage's questions ask the reader to recover. Its structural novelty is a DELIBERATE EXCEPTION ASSERTED IN THE POSITIVE - this passage withholds three of its four and GLOSSES the fourth on purpose (the question about 'our white elephant' turns on the possessive, not the phrase), so the record carries a glossed flag, glossary-silence runs on the three, the glossary must REALLY DEFINE the fourth, and the BANK check runs on all four regardless. The flag therefore cannot be flipped onto a second entry to silence an inconvenient check, and a negative mutation proved the exception load-bearing. THE GATE SAYS PLAINLY WHAT IT DOES NOT COVER: a year is the only shelf-life marker a script can see; 'no work, no person, no brand' is the authoring rule and the reader pass, and a gate implying more coverage than it has is worse than none (T-04-13 accepted, in writing). 04-05's CORPUS HARVESTER WAS BROKEN and this plan found it before authoring: its push guard required typeof text === 'string', so every reading passage BODY (a string[]) was silently absent from the corpus, along with every glossary (wrong field names) and every reading question prompt (q.prompt vs q.q). Rebuilt to 4,284 fields against 3,744 - so every scan here covered surfaces no prior plan's scan reached, INCLUDING native/culture's own letter home, which is exactly the text these banks must not collide with. Zero exact duplicates; four fields rewritten after the scan (a Spanish frame shared with social/humor's went-over-my-head, a 'to be honest' tail shared with a LIVE native/register phrase, 'for what it's worth' which native/idioms teaches outright, and 'redundant' which two live cards own in another sense); then both banks READ CONSECUTIVELY and six more rewritten for shared shapes no threshold flagged. Phrases highest J=0.375, deck highest genuine J=0.300, >=6-word view 0.333; one pair at exactly 0.500 (read the room vs work/networking's LIVE work-the-room) was ACTED ON rather than filed, replaced by 'topical'. Five frames found against the EXISTING eight cards were MEASURED at J=0.094-0.129 and KEPT, because clearing them would mean editing a field behind an id committed forty minutes earlier - a changed hash - and a 0.10 overlap does not buy a one-way door. Mutation sweep 10 declared / 8 of 8 CAUGHT / negative confirmed / 2 controls green / byte-identity IDENTICAL. TWO mutations failed on run 1 and BOTH were my mutations' defects, not the gate's: M5 prepended glossed:true to an object that already carried glossed:false - a DUPLICATE KEY, last one wins, semantically inert - and N1 joined its anchor lines with a bare newline against a file that is CRLF on disk, so it matched 0 times and the refusal branch left the file byte-identical. 04-04's rule applied rather than restated. minutes 10 to 13 at Task 1 and 13 to 17 at Task 2, each in the same commit as the growth (18x20 + 42-card deck x15 = 990 s, 30 s slack). verify-scenario-content 13832 to 14325; verify-id-stability 1875 to 1959, 632 ids and 15 retired (UNCHANGED); ZERO ids retired, ZERO re-pointed, ZERO changed hashes, so NO one-way-door decision was put to the user for the second consecutive plan. Payload 199,631 B / 19.0 percent over 733 ids; merge 25647, schema 309, queue 173, headers 24, celpip 43/648/50 all held; tsc, lint and build exit 0 from the COMMITTED tree after a .next wipe, with the bundle grepped for the new slugs and minutes:17; dependencies 11 + 11; port 3000 free before and after. LOGGED TO deferred-items.md AND WINDOWS: native/culture's own BRIEFING says 'That is so 2010' - a literal four-digit year in the one scenario whose banks are now gated against years - but scenario-lessons.ts is outside this plan's files_modified and the tip is arguably demonstrating the phenomenon rather than falling for it. WINDOWS 45 RECURRED FOR A FOURTEENTH CONSECUTIVE PLAN: update-progress again DELETED the informative Progress parenthetical for a bare '93%', total_phases still read 5 against a ROADMAP holding 6 phases, and record-metric AGAIN returned success while writing nothing (the Performance Metrics table has been a placeholder for all 42 plans, so no row was fabricated for this one alone). All hand-corrected, touching only my own rows; the 109 historical [Phase ?] decision lines counted before and after and untouched, the 3 new ones being mine. CONT-04 NOT ticked - this is plan six of nine and native/pronunciation still sits at Phase 3 floors. 3 of 9 plans remain in Phase 4.

Progress: [█████████░] 42 of 45 plans (4 of 6 phases complete; Phase 4 has 9 plans written and 6 executed)
...
Last session: 2026-08-04T08:29:35.497Z
