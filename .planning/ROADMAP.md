...
- [ ] **Phase 1: Server-Side Progress** - Postgres becomes the authoritative, validated, retry-safe home of learner progress across devices
- [ ] **Phase 2: Every Scenario Practicable** - Audit and fill content so all existing scenarios offer real practice in every applicable skill, feeding SRS and weak topics
- [ ] **Phase 3: Full Curriculum Expansion** - Expand the 6 worlds to their complete designed topic coverage with graduated B1–C1 and native-level content
- [ ] **Phase 4: AI Tutor End-to-End** - Real Claude tutor live in production: scenario role-play, gentle correction, graceful gating/errors, progress credit

## Phase Details

### Phase 1: Server-Side Progress
...
### Phase 2: Every Scenario Practicable
...
**Depends on**: Phase 1 (content work is independent, but ordering it after ensures new completions are recorded server-side)
...
### Phase 3: Full Curriculum Expansion
...
**Depends on**: Phase 2 (extends the fully-practicable content baseline and reuses its content patterns)
...
**Depends on**: Phase 1 (tutor progress credit must persist server-side); ordered last per the 2026-06-19 decision (free features first, paid tutor last)
...
|-------|----------------|--------|-----------|
| 1. Server-Side Progress | 0/TBD | Not started | - |
| 2. Every Scenario Practicable | 0/TBD | Not started | - |
| 3. Full Curriculum Expansion | 0/TBD | Not started | - |
| 4. AI Tutor End-to-End | 0/TBD | Not started | - |
