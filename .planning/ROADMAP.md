...
- [ ] **Phase 1: CELPIP Writing Practice** - Free exam-prep section at `/celpip`: original Task 1/Task 2 bank, real-exam simulator (timer, word count), model answers + descriptor-based self-evaluation
...
**Plans**: 6 plans
Plans:
- [ ] 01-01-PLAN.md — Tracer: end-to-end writing slice (data → storage → route → simulator → results → persist)
- [ ] 01-02-PLAN.md — Task 1 email bank (~8 original formal-email tasks + model answers + tips)
- [ ] 01-03-PLAN.md — Task 2 survey bank (~8 original opinion tasks + model answers + tips)
...
|-------|----------------|--------|-----------|
| 1. CELPIP Writing Practice | 0/6 | Not started | - |
